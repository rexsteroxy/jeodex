...
@section('content')
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold">DOMESTIC COURIER SOLUTIONS</h1>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 order-md-1" data-aos="fade">
            <div class="text-left pb-1 border-primary mb-4">
              <h2 class="text-primary">OUR DOMESTIC COURIER SOLUTIONS SERVICE</h2>
              <p style="color:red">A REPUTATION FOR SPEED AND RELIABILITY</p>
            </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4"></div>
          <h1 class="font-weight-light text-uppercase font-weight-bold" style="color: red">How We Work</h1>
        </div>
        <br><hr>
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="#">EXPRESS DELIVERY SERVICES
              </a></h2>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="#">PICKUP AND DELIVERY SERVICES</a></h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eligendi nobis ea maiores sapiente veritatis reprehenderit suscipit quaerat rerum voluptatibus a eius.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="#">HOUSEHOLD MOVING & OFFICE RELOCATION SERVICES</a></h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eligendi nobis ea maiores sapiente veritatis reprehenderit suscipit quaerat rerum voluptatibus a eius.</p>
            </div> 
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="#">MAIL ROOM SERVICES</a></h2>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="#">JEODEX BUSINESS SOLUTIONS</a></h2>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="#">SENSITIVE & FRAGILE TECHNOLOGY FREIGHT</a></h2>
