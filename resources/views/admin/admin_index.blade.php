...
<body>
    ...
    <section id="container" class="">
        ...
        <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="{{('/admin')}}" class="logo">Admin <span class="lite">Dashboard</span></a>
            <!--logo end-->
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-laptop"></i> JOHDEX LOGISTICS</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box blue-bg">
                            ...
                            <div class="title">Total Delivered Packages</div>
                        </div>
                        <!--/.info-box-->
                    </div>
                    <!--/.col-->
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box brown-bg">
                            ...
                            <div class="title">Damaged Packages</div>
                        </div>
                        <!--/.info-box-->
                    </div>
                    <!--/.col-->
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box dark-bg">
                            ...
                            <div class="title">Packages on Route</div>
                        </div>
                        <!--/.info-box-->
                    </div>
                    <!--/.col-->
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box green-bg">
                            ...
                            <div class="title">Delivery Success Rate</div>
                        </div>
                        <!--/.info-box-->
                    </div>
                    <!--/.col-->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table class="table bootstrap-datatable countries">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="{{ ('admin_img/Germany.png') }}" style="height:18px; margin-top:-2px;"></td>
                                            <td>Germany</td>
                                            <td>2563</td>
                                            <td>1025</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src="{{ ('admin_img/India.png') }}" style="height:18px; margin-top:-2px;"></td>
                                            <td>India</td>
                                            <td>3652</td>
                                            <td>2563</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src="{{ ('admin_img/Spain.png') }}" style="height:18px; margin-top:-2px;"></td>
                                            <td>Spain</td>
                                            <td>562</td>
                                            <td>452</td>
                                            <td>
                                    ...
                                    <!-- <ul class="chats"> -->
                                        ...
                                        <!-- <li class="by-me"> -->
                                            ...
                                            <!-- <div class="avatar pull-left"> -->
                                                <!-- <img src="{{ ('admin_img/user.jpg') }}" alt="" /> -->
                                            <!-- </div> -->
                                        ...
                                        <!-- <li class="by-other"> -->
                                            ...
                                            <!-- <div class="avatar pull-right">
                                                <img src="{{ ('admin_img/user22.png') }}" alt="" />
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <span class="profile-ava pull-right">
                                            <img alt="" class="simple" src="{{ ('admin_img/avatar1_small.jpg') }}">
                                            Jenifer smith
                                        </span>
                                    </div>
                                </div>
          ...
          -->
                    Designed by <a href="#">SunnyLearner</a>
                </div>
            </div>
        </section>
        <!--main content end-->
    ...
    <<script src="{{ ('admin_js/fullcalendar.min.js') }}">
        </script>
